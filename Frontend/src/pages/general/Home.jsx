...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://reelbite-r9zo.onrender.com/api/auth/user/me", {
    ...
    axios
      .get("https://reelbite-r9zo.onrender.com/api/food/reels", {
        withCredentials: true,
      })
      .then((response) => {
  ...
  async function likeVideo(item) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://reelbite-r9zo.onrender.com/api/food/like",
        { foodId: item._id },
        { withCredentials: true },
      );
  ...
  async function saveVideo(item) {
    ...
    try {
      ...
      // Make API call
      const response = await axios.post(
        "https://reelbite-r9zo.onrender.com/api/food/save",
        { foodId: item._id },
        { withCredentials: true },
      );
